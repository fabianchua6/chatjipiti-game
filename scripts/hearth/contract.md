...
Node tests need explicit .ts extensions in ALL transitive pure TypeScript imports. Playwright desktop has no touch support: use click or keyboard there; use tap only in the isMobile project.
