...
- Circle 90+ displays Pope Tibo and golden CODEX RESET BLESSED text; every winning round earns one demo reset in either mode. Duplicate submission of the same round must not award twice.
...
- Earlier room pointer test scored 98.8/100 and displayed the blessing. The former daily reward cap has been replaced by repeatable demo rewards.
